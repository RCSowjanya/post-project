          ...
          <div className="flex justify-between max-[1100px]:flex-col">
            ...
            <div className="w-2/5 max-[1100px]:w-full mb-[6%]">
              ...
              <div className="flex gap-4 mb-8">
                <img src={s1} className="w-16 h-16" alt="samplepageimg-1" />
                <div className="">
              ...
              <div className="flex gap-4 mb-8">
                <img src={s2} className="w-16 h-16" alt="samplepageimg-2" />
                <div className="">
              ...
              <div className="flex gap-4 mb-8">
                <img src={s3} className="w-16 h-16" alt="samplepageimg-3" />
                <div className="">
